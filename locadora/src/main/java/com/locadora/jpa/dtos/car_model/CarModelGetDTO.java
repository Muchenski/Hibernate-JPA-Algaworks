...
public class CarModelGetDTO extends DefaultResourceableDTO {
	...
	public CarModelGetDTO() {
		super();
	}

	public CarModelGetDTO(LocalDateTime creationDate, LocalDateTime updateDate, Long id, String description,
