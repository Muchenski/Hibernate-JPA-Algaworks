...
public class RentGetDTO extends DefaultResourceableDTO {
	...
	public RentGetDTO(LocalDateTime creationDate, LocalDateTime updateDate, Long id, LocalDateTime requestDate,
