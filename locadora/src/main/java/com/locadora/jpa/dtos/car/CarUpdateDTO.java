...
public class CarUpdateDTO extends DefaultResourceableDTO {
	...
	public CarUpdateDTO(LocalDateTime creationDate, LocalDateTime updateDate, Long id, String licensePlate, String chassis,
