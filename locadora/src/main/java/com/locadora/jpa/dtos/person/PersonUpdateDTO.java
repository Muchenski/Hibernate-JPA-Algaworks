...
public class PersonUpdateDTO extends DefaultResourceableDTO {
	...
	public PersonUpdateDTO(LocalDateTime creationDate, LocalDateTime updateDate, Long id, String name, Date birthDate,
